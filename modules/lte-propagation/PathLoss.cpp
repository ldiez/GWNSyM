...
UmaPathloss(units::m distance, units::GHz frec, units::m hbs, units::m hut)
{
    ...
    if (distance_ < 10)
    {
        return {units::dB(0.0), PropType_e::LOS};
    }
    else if (distance_ > 5000)
    {
        return {units::dB(MaxLoss_s), PropType_e::NLOS};
    }
    std::random_device rd_;
    std::default_random_engine rng_(rd_());
    ...
    if (r_ <= pLos_)
    {
        return {UmaPathloss_LOS(distance, frec, hbs, hut), PropType_e::LOS};
    }
    return {UmaPathloss_NLOS(distance, frec, hbs, hut), PropType_e::NLOS};
}
...
UmiPathloss(units::m distance, units::GHz frec, units::m hbs, units::m hut)
{
    ...
    if (r_ <= pLos_) //LOS
    {
        return {UmiPathloss_LOS(distance, frec, hbs, hut), PropType_e::LOS};
    }
    return {UmiPathloss_NLOS(distance, frec, hbs, hut), PropType_e::LOS};
}
...
UpiPathloss(units::m distance, units::GHz frec, units::m hbs, units::m hut)
{
    ...
    if (r_ <= losProb_)
    {
        return {UpiPathloss_LOS(distance, frec, hbs, hut), PropType_e::LOS};
    }
    return {UpiPathloss_NLOS(distance, frec, hbs, hut), PropType_e::NLOS};
}
