...
void
LteUe::AddCellInfo(gnsm::Ptr_t<LteCell> cell, Power rsrp, units::dB ulPl, EnbType type)
{
    BEG;
    ...
    m_orderedDl = false;
    m_orderedUl = false;
    m_sensedDlPower.push_back({cell, rsrp, type});
    m_ulEstimates.push_back({cell, ulPl, type});
    END;
}
